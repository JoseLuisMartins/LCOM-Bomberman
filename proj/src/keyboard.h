 ...
 *
 * @return Return OK upon success and non-zero otherwise
 */
 ...
 * Evaluates scancode's content (checks if it has one or two bytes)
 *
 * @param[out] scancode pointer to keyboard read info
 *
 * @return Returns 0 when scancode is complete
 */
...
/**
 * @brief Reads keyboard's info, from OUT_BUF
 *
 * @param[out] data keyboard's info
 *
